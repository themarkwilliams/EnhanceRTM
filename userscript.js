...
/* Others */
GM_addStyle('.b-c-d-e-f-Xr-o { background-color: #0060BF !important; }'); //12/16/16

/* Get Rid of the Pro Nag in the lower left */
GM_addStyle('.b-Ep-jo-Rj-Yn { display:none !important;}'); //12/16/16
GM_addStyle('.b-Ep-Ej-Fp-Yn { height:90%; }');//12/16/16
